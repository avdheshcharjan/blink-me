...
> {
  const icon =
    'https://ucarecdn.com/e810518d-6ab1-45ed-a72e-57011b2e9a01/AvdheshCharjanCBPfp1.jpeg';
  const title = 'Donate to Avu';
  const description =
    'multi chain maxi monke, PEPE lover & a broke student';
